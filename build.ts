...
async function buildGasProject(): Promise<void> {
    try {
        // Generate loadedPrompts.ts first, then run type checking
        ...
        try {
            ...
            const tsContent = `// This file is auto-generated by build.ts. Do not edit directly.\n` +
                ...
                `}\n\n` +
                `export const PROMPTS: PromptsConfig = ${JSON.stringify(parsedPrompts, null, 2)};\n`
        ...
        // Type checking is now handled by npm script
