...
import * as yaml from 'js-yaml'; // Added for YAML processing
...
async function buildGasProject(): Promise<void> {
    try {
        ...
        // --- Start of YAML prompt processing ---
        ...
        try {
            ...
            // Ensure parsedPrompts is not undefined or null before stringifying
